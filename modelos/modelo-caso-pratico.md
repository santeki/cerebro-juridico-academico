...
## Resolução
{Por questão: identificação do instituto e da norma → preenchimento (ou não) dos pressupostos face aos factos → consequência jurídica. Cada passo remete para [[Institutos/...]] e cita a norma. Onde a qualificação seja disputada, abrir as leituras alternativas e a consequência de cada uma.}

## Armadilhas do enunciado
