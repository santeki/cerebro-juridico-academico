...
{Quando STJ e Relações divergem, ou Relações entre si, sem uniformização (sub-tipo IV do Eixo B): mapear quem decide o quê.}

## Articulação com a doutrina
{Onde a doutrina acompanha ou critica a linha. Desalinhamento doutrina ↔ jurisprudência (sub-tipo V) se existir.}
