...
### Peso próprio de cada frase

Cada parágrafo e cada frase carregam substância jurídica própria. A frase-moldura, que anuncia o que a seguinte vai dizer, prepara terreno ou comenta a exposição em vez de a fazer, elimina-se, e o que nela houvesse de conteúdo funde-se na afirmação que a seguia. O teste é de supressão: apagada a frase, perde-se informação jurídica? Se nada se perde, a frase não devia existir. Moldes desta espécie, em lista exemplificativa e não exaustiva: «importa notar», «convém referir», «cumpre dizer», «vale a pena destacar», «note-se que», «dito isto», «posto isto», «em traços largos», «reduzido ao essencial», «a questão é a seguinte», «diga-se desde já», «como veremos», «há dois pontos a considerar».

A frase certa é a mais simples que sustente a maior profundidade jurídica disponível. Simplicidade não é encurtamento nem pobreza lexical, e mede-se por dizer o mesmo com menos aparato, sem perder distinção, ressalva ou âncora; profundidade não é acumulação, e mede-se pela distinção que decide o caso, pela qualificação que muda a consequência e pela ressalva que evita o erro. Entre duas formulações de igual conteúdo vence a mais simples; entre duas de igual simplicidade vence a de maior alcance jurídico.

O crivo confere os moldes catalogados e a falha bloqueia. O critério da melhor frase é de juízo, não se mecaniza, e cumpre-se na revisão de quem escreve e na revisão cega que a segue.
