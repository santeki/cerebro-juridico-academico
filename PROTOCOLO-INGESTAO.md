...
2. Integrar a afirmação na página, com wikilink para a página de fonte e a âncora de localização. Cada frase substantiva fica rastreável (regra 4 do `CLAUDE.md`). Em página de conceito, a afirmação doutrinária integra-se na secção *Posição de [Autor]* respectiva e a *Ideia* da página revê-se no mesmo passo (`modelos/modelo-conceito.md`).
