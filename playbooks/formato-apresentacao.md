...
Um item → mensagem simples. Vários itens → uma âncora seguida de um bloco por item.
...
A decisão item-a-item evita três custos: triar tudo num bloco, parsing de respostas do tipo «sim ao 2 e ao 4», e a perda de um item no meio de um muro. O custo de uma âncora a mais é nulo; o de um muro de texto é fricção real. Na dúvida sobre se um conjunto é «multi-item», tratá-lo como multi-item.

## Articulação

O vocabulário é o da supressão (`wiki/SUPRESSAO-LIST.md`): ❌ num item não é só «salta», é «não voltes a propor», e o agente acrescenta-o à lista de supressão. ⏸ deixa o item para a passagem seguinte. ✅ avança. Onde o item alimenta o painel (`PROTOCOLO-PAINEL.md`), o identificador estável é o mesmo, para o seguires de uma peça para a outra.
