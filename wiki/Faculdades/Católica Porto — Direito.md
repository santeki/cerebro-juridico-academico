...
> Vista curricular da Católica Porto sobre o corpo de conhecimento da wiki. Fonte única, por ora: a página oficial da UC «Introdução ao Estudo do Direito» ([[Fontes/Página da UC — Introdução ao Estudo do Direito (Católica Porto, captura 2026-07-09)]]). Tudo sai dessa página; nada foi inferido. A página não indica ano curricular nem semestre - a cadeira entra sem posição no plano até fonte que a fixe.
...
- **Docente**: a página não designa regente; lista como «Assistente Convidado(a)»: Antónia Fontes de Almeida, Mónica Duque, Paula Ponces Camanho, José Correia de Matos, Nuno Alonso Paixão (página, pp. 3-5).
- **Padrão de ensino do docente**: por preencher - sem fonte verificada; não se preenche de memória.
- **Avaliação**: a página não indica regime nem datas.
- **Bibliografia base**: a página não indica bibliografia.
- **Fontes da cadeira em `raw/`**: `raw/Universidade Católica Portuguesa — Porto/Ano por confirmar/Semestre por confirmar/Introdução ao Estudo do Direito/Programa/`.
...
- **Programa** (página, p. 2; transcrição ponto a ponto - as Partes I, II e IV surgem só com título, sem sub-pontos; a lista não se completa além do que a fonte dá) → páginas de conhecimento:
  ...
  6. O problema - [[Conceitos/Fontes de Direito]] - monocamada (BM, cap. VI, § 1: positivação, «questão jurística», crítica ao fundamento factual da validade). **Nota de alcance ASC (2026-07-26, sessão 8), sem conversão**: o problema das fontes é tratado de frente por ASC no n.º 143 - «verdadeira fonte do direito é sempre e só a ordem social; só desta deriva afinal a juridicidade de qualquer regra» (p. 243) - e no n.º 144, e o material vive em [[Conceitos/Fontes de Direito]] em eixo próprio contra a construção da positivação de BM. **Convertido a bicamada a 2026-07-27, por autorização expressa do aluno**: os nn. 143-144 dão a segunda voz sobre o mesmo recorte do § 1 do cap. VI de BM, com o eixo próprio aberto na página do conceito.
  7. A Lei, as normas corporativas, a jurisprudência, a doutrina, o costume, os usos, os princípios fundamentais de Direito - [[Conceitos/Fontes de Direito]] - monocamada (BM, cap. VI, §§ 2-8; a vigência e a hierarquia, fora do recorte desta Parte, em [[Conceitos/Vigência das Normas]]). **Nota de alcance ASC (2026-07-26, sessão 8 - Título VI, cap. I, parte 1)**: cinco dos sete itens do recorte ficam cobertos por ASC - lei (nn. 157-165), normas corporativas e entes intermediários (n.º 160), doutrina (n.º 148), costume (nn. 149-156) e usos (n.º 156). A jurisprudência corre nos nn. 178-185 (sessão 9) e os princípios fundamentais não têm sede própria neste capítulo. **Alteração de 2026-07-26 (sessão 9)**: com os nn. 178-185, a **jurisprudência** passa a estar coberta pela segunda voz, e o ponto sobe a **seis dos sete itens em bicamada**, ficando de fora apenas os **princípios fundamentais de Direito**, que o capítulo I do Título VI não trata em sede própria. Conversão a bicamada parcial autorizada pelo aluno em 2026-07-26.
...
- **Cobertura do programa**: Partes I-VII cobertas (BM, caps. I-VIII, fechadas em 2026-07-09/10/11) - **o programa enumerado está integralmente coberto**, e o **ponto 7 da Parte V** passa a **bicamada parcial em 2026-07-26**, por autorização do aluno: dele, seis dos sete itens têm segunda voz com o Título VI, cap. I de ASC (a lei, as normas corporativas, a jurisprudência, a doutrina, o costume e os usos), ficando de fora os **princípios fundamentais de Direito**, que o capítulo não trata em sede própria. **A 2026-07-27, por autorização do aluno, convertem-se mais três a bicamada**: a **Parte II** («A Macroestrutura do Direito») com o Título VI, cap. II de ASC; o **ponto 5 da Parte III** («Técnicas legislativas») com o Título VI, cap. III; e o **ponto 6 da Parte V** («O problema»), cuja nota de alcance de 2026-07-26 estava escrita e não decidida, com os nn. 143-144. As restantes Partes mantêm-se em monocamada BM; a bicamada dessas aguarda os manuais seguintes da fila. Actualiza-se no fecho de cada estudo.
- **Histórico de avaliações**: sem fontes de avaliação ingeridas.

## Fila de prioridade (Católica Porto)
1. Obter a ficha completa da UC (ano curricular, semestre, regência, bibliografia, avaliação) - a página capturada não os dá.
2. Baptista Machado, *Introdução ao Direito e ao Discurso Legitimador* - em ingestão; fecha pontos das Partes III e V-VII ([[Fontes/Baptista Machado, Introdução ao Direito e ao Discurso Legitimador]]).
