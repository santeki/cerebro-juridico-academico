...
- Castanheira Neves, «ob. cit., pp. 353 e 359» (BM, p. 36) — hipótese principal: *As Fontes do Direito e o problema da positividade jurídica*, BFD Coimbra, vol. LI (1975), pp. 115 e sgs. (nota da p. 159); o cap. VII alargou o leque — *A Unidade do Sistema Jurídico* (Coimbra, 1979; nota p. 197) e *Questão-de-Facto-Questão-de-Direito* (Coimbra 1967, ≥ 309 pp.; nota p. 203) — sem deslocar a hipótese. [BLOQUEADA: à espera do vol. LI do BFD — inacessível em linha; verificação em biblioteca]
- BM cap. V: epígrafe/texto do art. 223º da CRP de 1976 originária por confirmar em fonte primária (fecha a oscilação «Conselho Superior Judiciário»/«da Magistratura», pp. 140/150). O cap. VII não a tocou.
